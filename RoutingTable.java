...
public class RoutingTable {
    ...
    public Route getRoute(int routeSeq) {
    	return table.get(routeSeq);
    }
    
    public void removeRoute(int routeSeq) {
    	Route temp = getRoute(routeSeq);
    	long temp2 = new Date().getTime();
    	if (temp2 - temp.getTimeStamp().getTime() > 4000) {		
    		table.remove(routeSeq);
    	}	
    }
