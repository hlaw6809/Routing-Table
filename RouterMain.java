...
public class RouterMain {
    private static final int ADD_WAIT = 5000;           //Time to wait in ms
    private static final int INITIAL_TABLE_SIZE = 0;   //Initial size of routing table
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ADD_LOOPS; i++) {
            ...
            if (i % 3 == 0) {
            	for (Route r : table.getTable()){
            		if (!r.isActiveFlag()) {
            			table.removeRoute(r.getSeqNumber());
            		}
            	}
            }
        }
